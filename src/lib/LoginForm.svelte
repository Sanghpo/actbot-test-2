<script lang="ts">
  ...
  import { signInWithEmail, signInWithGoogle, resetPassword } from '../stores/authStore'
  ...
  async function handleForgotPassword() {
    ...
    if (result.success) {
      resetMessage = result.message || 'Password reset email sent'
    } else {
...
<div class="login-form">
  <div class="form-header">
    ...
    <p>Don't have an account? 
      <button class="header-link" on:click={switchToSignup}>Sign up</button>
    </p>
  </div>
